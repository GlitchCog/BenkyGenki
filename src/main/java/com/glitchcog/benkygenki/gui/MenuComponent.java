...
/**
 * Simple grouping of a label, a mnemonic key to press, and a shortcut key combination accelerator, together
 * representing an entry on the main menu
 * 
 * @author Matt Yanos
 */
public class MenuComponent
{
    ...
    /**
     * The letter to underline and the key to press to make a selection when using the keyboard to navigate the menu
     */
     ...
     *            The String to be displayed on the menu
     * @param mnemonic
     *            The letter to underline and the key to press to make a selection when using the keyboard to navigate
     *            the menu
     * @param accelerator
     *            The keyboard shortcut combination for the menu item
     */
