...
/**
 * From: https://raw.githubusercontent.com/ernieyu/Swing-range-slider/
 * 
...
class RangeSliderUI extends BasicSliderUI {
    ...
    private Color rangeColor = new Color(0xAA, 0xAA, 0xAA);
    ...
    public void paintTrack(Graphics g) {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            // Draw selected range.
            for (int y = 0; y <= 3; y++) {
                g.setColor(y == 1 ? rangeColor.brighter() : rangeColor);
            ...
            // Draw selected range.
            for (int x = 0; x <= 3; x++) {
                g.setColor(x == 1 ? rangeColor.brighter() : rangeColor);
